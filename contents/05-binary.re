...
@<code>{0}、@<code>{1}、@<code>{2}、・・・、@<code>{8}、@<code>{9}と大きくなっていき、「一の位」が「十」集まると上の位に「進」みます。

@<code>{10}、@<code>{11}、・・・、@<code>{99}と大きくなっていき、「十の位」が「十」集まると上の位に「進」みます。

@<code>{100}、@<code>{101}、・・・、@<code>{999}と大きくなっていき、「百の位」が「十」集まると上の位に「進」みます。

「十」集まって一つ上の位に「進」むたびに、その桁の重みが十倍になっていくのが、「十進数」の特徴です。
例えば、「@<code>{９４３}」という数なら、百を９つと、十を４つ、一を３つ 併せた数のことです。
//blankline

二進数でも同様ですので、見ていきましょう。

@<code>{0}、@<code>{1} と大きくなっていき、「一の位」が「二」集まると上の位に「進」みます。
//}

@<code>{10}、@<code>{11} と大きくなっていき、「二の位」が「二」集まると上の位に「進」みます。

@<code>{100}、@<code>{101} 〜 @<code>{111}と大きくなり、「四の位」が「二」集まると上の位に「進」みます。

「二」集まって一つ上の位に「進」むたびに、その桁の重みが二倍になっていくのが、「二進数」の特徴です。
例えば、「@<code>{1011}」という数なら、八を１つと、二を１つ、１を１つ 併せた数のこと、つまり、@<code>{じゅういち} のことです。

//blankline
二進数では、すぐに桁数が増えていって数えにくいので、四桁をひとまとめにした、十六進数もよく使われます。十六進数では、@<code>{10}〜@<code>{15}までの数を一桁で表せるよう記号を準備する必要があります。黎明期には様々な記号が提案されましたが、今日では@<code>{A}〜@<code>{F}までのアルファベットの使用が定着しました。 @<fn>{sankou}
